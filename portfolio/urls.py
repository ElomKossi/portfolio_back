...
from .views import (
    EducationGenericAPIView,
    ExperienceGenericAPIView,
    ProjectGenericAPIView,
    SkillGenericAPIView,
    TechnologyGenericAPIView,
    InterestGenericAPIView,
)

urlpatterns = [
    path("education", EducationGenericAPIView.as_view(), name="education_api"),
    path(
        "education/<str:pk>", EducationGenericAPIView.as_view(), name="education_pk_api"
    ),
    path("experience", ExperienceGenericAPIView.as_view(), name="experience_api"),
    path(
        "experience/<str:pk>",
        ExperienceGenericAPIView.as_view(),
        name="experience_pk_api",
    ),
    ...
    path(
        "technology/<str:pk>",
        TechnologyGenericAPIView.as_view(),
        name="technology_pk_api",
    ),
